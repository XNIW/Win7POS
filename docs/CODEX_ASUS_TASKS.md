...
| ASUS-W7POS-013 | Review | Non-blocking catalog display-text recovery and warning summary | PR #45 merged; single staging acceptance stopped at bootstrap_failure | `docs/plans/WIN7POS_CATALOG_TOLERANCE_001.md`; only display fields may recover, while identity, price, exactness and sale-safety remain fail-closed. |
