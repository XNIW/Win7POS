...
namespace Win7POS.Data.Online
{
    public sealed class PosShopTransitionGuard
    {
        private static readonly string[] ShopScopedStatusKeys =
        {
            ...
            CatalogShopStateRepository.ObservedRevisionKey,
            CatalogShopStateRepository.ObservedRevisionAtKey,
            CatalogShopStateRepository.CommittedRevisionKey,
            CatalogShopStateRepository.CommittedRevisionAtKey,
            CatalogShopStateRepository.ImportAckGenerationKey,
            CatalogShopStateRepository.ImportReconciledGenerationKey,
